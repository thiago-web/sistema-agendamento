...
(function(e) {
    ...
    }) : "object" === typeof exports ? module.exports = function(r, q) {
        r || (r = window);
    ...
    e.extend(n.prototype, {
            ...
            for (var g =
                ...
                if (l)
                    if (Array.isArray(l)) this._expandButton(a, l, c, d);
                        ...
                        j && (d !== m && null !== d ? (a.splice(d, 0, j), d++) : a.push(j), j.conf.buttons && (j.collection = e("<" + this.c.dom.collection.tag + "/>"), j.conf._collection = j.collection, this._expandButton(j.buttons, j.conf.buttons, !0, d)), l.init && l.init.call(g.button(j.node), g, e(j.node), l), f++)
                    }
            }
        },
        _buildButton: function(a, b) {
            ...
            var k = function(a, b, c, d) {
                ...
                j = e("<" + g + "/>").addClass(c.className).attr("tabindex", this.s.dt.settings()[0].iTabIndex).attr("aria-controls", this.s.dt.table().node().id).on("click.dtb", function(b) {
                    b.preventDefault();
                    !j.hasClass(c.disabled) && a.action && k(b, f, j, a);
                    l && j.trigger("blur")
                }).on("keyup.dtb", function(b) {
                    b.keyCode === 13 && !j.hasClass(c.disabled) && a.action && k(b, f, j, a)
                });
        ...
        _popover: function(a, b, c) {
            ...
            c.length && (f = c.eq(0), h());
            c = e("<div/>").addClass("dt-button-collection").addClass(g.collectionLayout).css("display", "none");
            ...
            var d = e(b.table().container()),
                k = c.css("position");
            "dt-container" === g.align && (f = f.parent(), c.css("width", d.width()));
            if ("absolute" === k && (c.hasClass(g.rightAlignClassName) || c.hasClass(g.leftAlignClassName) || "dt-container" ===
                    g.align)) {
                var l = f.position();
                c.css({
                    top: l.top + f.outerHeight(),
                    left: l.left
                });
                var j = c.outerHeight(),
                ...
                var l = d.offset().left,
                    ...
                    p = o + p,
                    o = 0;
                c.hasClass(g.rightAlignClassName) ? (o = p - s, l > k + o && (k = l - (k + o), d -= s + o, o = k > d ? o + d : o + k)) : (o = l - k, d < s + o && (k = l - (k + o), d -= s + o, o = k > d ? o + d : o + k));
                c.css("left", c.position().left + o)
            } else "absolute" === k ? (l = f.position(), c.css({
                top: l.top + f.outerHeight(),
                left: l.left
            }), j = c.outerHeight(), k = f.offset().top, o = 0, o = f.offset().left, p = f.outerWidth(), p = o + p, k = c.offset().left, s = a.width(), s = k + s, u = l.top - j - 5, i = d.offset().top + d.height(), t = l.top + f.outerHeight() + j, i = t - i, t = l.top - j, m = d.offset().top, (i > m - t || g.dropup) && -u < m && c.css("top", u), o = "button-right" === g.align ? p - s : o - k, c.css("left", c.position().left + o)) : (k = c.height() / 2, k > e(r).height() / 2 && (k = e(r).height() / 2), c.css("marginTop", -1 * k));
            ...
            e("body").on("click.dtb-collection", function(b) {
                ...
                (!e(b.target).parents()[c]().filter(a).length && !e(d).hasClass("dt-buttons") || e(b.target).hasClass("dt-button-background")) && h()
    ...
    n.background = function(a, b, c, d) {
        c === m && (c = 400);
        d || (d = q.body);
        a ? w(e("<div/>").addClass(b).css("display", "none").insertAfter(d), c) : x(e("div." + b), c, function() {
            e(this).removeClass(b).remove()
        })
    };
    n.instanceSelector = function(a, b) {
        if (a === m || null === a) return e.map(b, function(a) {
            return a.inst
        });
        var c = [],
    ...
    n.buttonSelector = function(a, b) {
        for (var c = [], d = function(a, b, c) {
                ...
                if (Array.isArray(a) || a instanceof e) {
                    ...
                    } else if (a.match(/^\d+(\-\d+)*$/)) f = e.map(i, function(a) {
                    return a.idx
                }), c.push({
                    inst: b,
                    node: i[e.inArray(a, f)].node
                });
                else if (-1 !== a.indexOf(":name")) {
                    var n = a.replace(":name", "");
                    f = 0;
                    for (h = i.length; f < h; f++) i[f].name === n && c.push({
                        inst: b,
                        node: i[f].node
                    })
                ...
                else "object" === typeof a && a.nodeName && (i = e.inArray(a, f), -1 !== i && c.push({
                    inst: b,
                    node: f[i]
                }))
        ...
        pageLength: function(a) {
            ...
            if (Array.isArray(a[0])) b = a[0], c = a[1];
                ...
                for (var d = 0; d < a.length; d++) {
                    var g =
                        a[d];
                    e.isPlainObject(g) ? (b.push(g.value), c.push(g.label)) : (b.push(g), c.push(g))
                }
            return {
                extend: "collection",
                text: function(a) {
    ...
    i.Api.register("buttons().containers()", function() {
        ...
        this.iterator(!0, "table", function(c) {
            if (c._buttons)
                for (var c = n.instanceSelector(b, c._buttons), d = 0, e = c.length; d < e; d++) a = a.add(c[d].container())
        });
        return a
    });
    ...
    i.Api.register("buttons.info()", function(a, b, c) {
        var d = this;
        if (!1 === a) return this.off("destroy.btn-info"), x(e("#datatables_buttons_info"), 400, function() {
            e(this).remove()
        }), clearTimeout(v), v = null, this;
        v && clearTimeout(v);
        e("#datatables_buttons_info").length && e("#datatables_buttons_info").remove();
        w(e('<div id="datatables_buttons_info" class="dt-button-info"/>').html(a ?
            "<h2>" + a + "</h2>" : "").append(e("<div/>")["string" === typeof b ? "html" : "append"](b)).css("display", "none").appendTo("body"));
        c !== m && 0 !== c && (v = setTimeout(function() {
            d.buttons.info(!1)
        }, c));
    ...
    i.Api.register("buttons.exportData()", function(a) {
        if (this.context.length) {
            var b = new i.Api(this.context[0]),
                ...
                d = b.table().footer() ? b.columns(c.columns).indexes().map(function(a) {
                    var d = b.column(a).footer();
                    return c.format.footer(d ? d.innerHTML : "", a, d)
                }).toArray() : null,
                g = e.extend({}, c.modifier);
            b.select && "function" ===
                typeof b.select.info && g.selected === m && b.rows(c.rows, e.extend({
                    selected: !0
                }, g)).any() && e.extend(g, {
                    selected: !0
                });
            for (var g = b.rows(c.rows, g).indexes().toArray(), f = b.cells(g, c.columns), g = f.render(c.orthogonal).toArray(), f = f.nodes().toArray(), h = a.length, k = [], l = 0, j = 0, p = 0 < h ? g.length / h : 0; j < p; j++) {
                for (var q = [h], r = 0; r < h; r++) q[r] = c.format.body(g[l], j, r, f[l]), l++;
                k[j] = q
            }
            a = {
                header: a,
    ...
    i.Api.register("buttons.exportInfo()", function(a) {
        ...
        b === m || null === b ? b = null : (-1 !== b.indexOf("*") && (b = b.replace("*", e("head > title").text()).trim()), b = b.replace(/[^a-zA-Z0-9_\u00A1-\uFFFF\.,\-_ !\(\)]/g, ""), (c = y(c.extension)) || (c = ""), b += c);
        c = y(a.title);
